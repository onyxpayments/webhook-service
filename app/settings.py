...
class Settings(BaseSettings):
    ...
    rabbitmq_retry_exchange: str = "webhook.retry"
    rabbitmq_retry_queue: str = "webhook.payment-notifications.retry.q"
    rabbitmq_retry_routing_key: str = "webhook.notification.retry"
    rabbitmq_dead_letter_exchange: str = "webhook.dead-letter"
    rabbitmq_dead_letter_queue: str = "webhook.payment-notifications.dlq"
    rabbitmq_dead_letter_routing_key: str = "webhook.notification.failed"
